...
//   return {
//     title: cat ? `${cat.label} | Lawella` : "Lawella",
//   };
// }
...
//   // 2. Fix the "possibly null" error by defaulting to empty array
//   const products = data || [];
...
//             {cat.label}
//           </h1>
//           <p className="mt-3 text-white/80">{products.length} handcrafted items</p>
//         </div>
//       </div>
